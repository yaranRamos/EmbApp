	...
	if(window.openDatabase){
		...
		if (db){
			db.transaction(function(tx){
				...
				tx.executeSql("CREATE TABLE IF NOT EXISTS medicamento (id INTEGER UNIQUE NOT NULL, medicamento VARCHAR(50) NOT NULL, fecha_inicio VARCHAR(10) NOT NULL, hora_ingesta VARCHAR(8) NOT NULL, frecuencia INTEGER NOT NULL, docificacion INTEGER NOT NULL, alarma VARCHAR(5) NOT NULL, duracion VARCHAR(2) NOT NULL, tipo VARCHAR(2) NOT NULL);");
